...
public:
  ...
  void seguir_linha() {
    ...
    if (enrolando == -1) {
      ...
      if (
        millis() - inicioEnrolamento >=
        tempoMaximoEnrolamento
      ) {
  ...
  void atualizar() {
    ...
    if (
      bloqueioObstaculo &&
      millis() - inicioBloqueioObstaculo >=
      tempoBloqueioObstaculo
    ) {
